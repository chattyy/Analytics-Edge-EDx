...
# Read in the data
Claims = read.csv("/Users/eshanchatty/Downloads/ClaimsData.csv")
...
# Baseline method which predicts that people have the same bucket over the years.
table(ClaimsTest$bucket2009, ClaimsTest$bucket2008)

(110138 + 10721 + 2774 + 1539 + 104)/nrow(ClaimsTest)

# Penalty Matrix, here wrongly classifying a high risk as a low risk has a higher penalty.
