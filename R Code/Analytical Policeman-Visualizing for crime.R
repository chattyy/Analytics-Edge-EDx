...
# Load our data:
mvt = read.csv("/Users/eshanchatty/Downloads/Visualization/mvt.csv", stringsAsFactors=FALSE)
...
# Load our data:
murders = read.csv("/Users/eshanchatty/Downloads/Visualization/murders.csv")
...
murderMap = merge(statesMap, murders, by="region")#by region is the identifier used to merge the rows.
str(murderMap)

# Plot the number of murder on our map of the United States:
ggplot(murderMap, aes(x = long,  y = lat, group = group, fill = Murders)) + geom_polygon(color = "black") + scale_fill_gradient(low = "black", high = "red", guide = "legend")

# Plot a map of the population:(To Check we are not saying murders are more cuz the population is more)
